...
const sparkOnly = (color, opacity = 1) =>
  Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="1024" height="1024">
...
const adaptiveForeground =
  Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="1024" height="1024">
  <g transform="translate(512 512) scale(0.62) translate(-512 -512)">${sparkOnly('#FFFFFF')
    .toString()
    .replace(/<\/?svg[^>]*>/g, '')}</g>
</svg>`);
...
async function write(name, input, size, opts = {}) {
  ...
  let img = sharp(input, { density: 384 }).resize(size, size, {
    fit: 'contain',
...
writeFileSync(
  path.join(ASSETS, 'brand/README.md'),
