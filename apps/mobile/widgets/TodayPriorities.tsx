 ...
 */
export function TodayPrioritiesWidget(
  props: TodayPrioritiesProps,
  ...
  return (
    ...
    >
      <HStack spacing={5}>
        ...
        <Spacer />
        {props.timeLabel ? (
          <Text modifiers={[font({ size: 11 }), foregroundStyle(c.tertiary)]}>
            {props.timeLabel}
          </Text>
        ) : null}
      </HStack>
      {!props.signedIn ? (
        ...
        <VStack alignment="center" spacing={0}>
          <Spacer />
          <Text
            modifiers={[font({ size: 13, weight: 'medium' }), foregroundStyle(c.ink), lineLimit(2)]}
          >
            {props.emptyTitle}
          </Text>
          <Spacer />
