...
export interface ProfileApi {
  ...
  updateProfile(
    patch: Partial<
      Pick<Profile, 'displayName' | 'firstName' | 'timezone' | 'locale' | 'avatarUrl'>
    >,
  ): Promise<Profile>;
  ...
  updateNotificationPreferences(
    patch: Partial<Omit<NotificationPreferences, 'userId' | 'createdAt' | 'updatedAt'>>,
...
export interface OnboardingApi {
  ...
  getInitialAnalysisStatus(): Promise<
    FirstAnalysisProgress & { insights: Insight[]; briefingId?: UUID | null }
  >;
}
...
export interface FeedApi {
  ...
  resolveInsight(
    id: UUID,
    status: Extract<InsightStatus, 'completed' | 'dismissed' | 'active'>,
...
export interface ApprovalsApi {
  ...
  createApproval<T extends ApprovalActionType>(
...
export interface RulesApi {
  ...
  upsertRule(
    rule: Omit<PriorityRule, 'userId' | 'createdAt' | 'updatedAt' | 'id'> & { id?: UUID },
...
export interface PrivacyApi {
  ...
  listAuditLogs(input?: {
    ...
    { action: string; actor: string; createdAt: ISODateTime; targetType?: string | null }[]
  >;
}
