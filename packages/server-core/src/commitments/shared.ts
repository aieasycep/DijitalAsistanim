...
export type CommitmentFormKind = 'future' | 'aorist' | 'progressive' | 'ability' | 'request' | 'expectation' | 'imperative';
...
export const NAME_STOPLIST = new Set(
  [
    'pazartesi', 'salı', 'çarşamba', 'perşembe', 'cuma', 'cumartesi', 'pazar', 'ocak', 'şubat', 'mart', 'nisan', 'mayıs', 'haziran', 'temmuz', 'ağustos', 'eylül',
    'ekim', 'kasım', 'aralık', 'yarın', 'bugün', 'dün', 'hafta', 'haftaya', 'sabah', 'akşam', 'öğlen', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday',
    'saturday', 'sunday', 'january', 'february', 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'november', 'december', 'tomorrow',
    'today', 'tonight', 'istanbul', 'ankara', 'izmir', 'bursa', 'antalya', 'adana', 'konya', 'gaziantep', 'kayseri', 'eskişehir', 'trabzon', 'samsun', 'mersin',
    'diyarbakır', 'kocaeli', 'sakarya', 'muğla', 'bodrum', 'türkiye', 'avrupa', 'almanya', 'londra', 'berlin', 'paris', 'amsterdam', 'newyork', 'dubai',
    'ofis', 'ofise', 'şirket', 'firma', 'banka', 'okul', 'ev', 'toplantı', 'ekip', 'departman', 'muhasebe', 'hukuk', 'satış', 'pazarlama', 'yönetim',
    'pdf', 'excel', 'word', 'powerpoint', 'zoom', 'teams', 'drive', 'slack', 'whatsapp', 'gmail', 'outlook', 'google', 'microsoft', 'apple', 'notion',
    'trello', 'jira', 'github', 'figma', 'canva', 'dropbox', 'linkedin', 'instagram', 'twitter', 'youtube', 'meet', 'skype', 'telegram', 'sap', 'erp', 'crm',
    'merhaba', 'selam', 'sayın', 'sevgili', 'değerli', 'ekte', 'ekteki', 'ayrıca', 'ancak', 'sonra', 'önce', 'lütfen', 'teşekkürler', 'saygılarımla', 'evet',
    'hayır', 'tamam', 'peki', 'ama', 'fakat', 'yani', 'bu', 'şu', 'o', 'biz', 'ben', 'siz', 'sen', 'hepimiz', 'herkes', 'kimse', 'bir', 'iki', 'üç', 'ilk',
    'son', 'toplam', 'genel', 'yeni', 'eski', 'revize', 'taslak', 'teklif', 'rapor', 'dosya', 'sözleşme', 'fatura', 'proje', 'sipariş', 'kargo', 'ürün',
    'müşteri', 'tedarikçi', 'yönetici', 'müdür', 'bey', 'hanım', 'hocam', 'abi', 'abla', 'hi', 'hello', 'hey', 'dear', 'thanks', 'regards', 'best', 'please',
    'the', 'this', 'that', 'we', 'you', 'they', 'it', 'also', 'and', 'but', 'then', 'ok', 'okay', 'yes', 'no', 'sure', 'great', 'thank', 'kind', 'have', 'will',
    'can', 'could', 'would', 'once', 'after', 'before', 'until', 'eod', 'cob', 'asap', 'fyi', 'q1', 'q2', 'q3', 'q4', 'v1', 'v2', 'v3', 'lorem', 'ipsum',
