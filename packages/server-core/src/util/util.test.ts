...
import { emailDomain, localDateKey, localHour, normalizeText, stripQuotedHistory, truncate, zonedTimeToUtc } from './index';
...
describe('util', () => {
  ...
  it('strips quoted history (tr + en)', () => {
    expect(stripQuotedHistory('Tamam, gönderirim.\n\nOn Fri, Sep 4 Ahmet wrote:\n> eski mesaj')).toBe('Tamam, gönderirim.');
  ...
  it('handles timezones', () => {
    ...
    expect(zonedTimeToUtc('2026-09-05', '07:30', 'Europe/Istanbul')).toBe('2026-09-05T04:30:00.000Z');
